        ...
        <div className="grid grid-cols-1 lg:grid-cols-[614px_614px] gap-8 lg:gap-12">
          {PARTNERS_LIST.map((partner) => (
            <Link
              ...
              className="group block lg:max-h-57 max-h-62 h-full"
            >
              <PartnerCard
                name={partner.name}
          ...
          >
            <motion.div
              ...
              className="relative rounded-2xl border-2 border-dashed border-primary/30 hover:border-primary/60 bg-primary/5 hover:bg-primary/10 transition-all duration-300 p-6 h-full flex flex-col items-center justify-center text-center gap-6 overflow-hidden cursor-pointer"
            >
